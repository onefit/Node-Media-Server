...
class NodeTransSession extends EventEmitter {
  ...
  run() {
    ...
    let customFlags = this.conf.customFlags || [];
    ...
    mkdirp.sync(ouPath);
    let argv = [];
    Array.prototype.push.apply(argv, customFlags);
    Array.prototype.push.apply(argv, ['-y', '-fflags', 'nobuffer']);
